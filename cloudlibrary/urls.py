...
import cloudlibrary.view.user_view as uesr_view
...
urlpatterns = [
    ...
    # 用户信息管理
    url(r'^person/(?P<uid>[0-9]*)/*$', uesr_view.person_info, name="personinfo"),
    url(r'^person/(?P<uid>[0-9]+)/page/(?P<page>[0-9]+)/*$', uesr_view.person_info, name="personinfo_with_page"),
    url(r'^edit_person/*', uesr_view.edit_person, name="edit_person"),

    # 书籍管理
    url(r'^addbook/*', book_view.add_book, name="addbook"),
    url(r'^deal_add_book/*', book_view.deal_add_book,name="deal_add_book"),
    url(r'^del_book', book_view.del_book, name="del_book"),
